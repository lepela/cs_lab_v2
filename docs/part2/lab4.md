...
> **예상 시간**: 50분 · **완성 신호**: `[이력서샘플]` 제목 메일을 보내면 **본인 [목록](../glossary.html#term-list)**에 새 항목이 생긴다
...
{: .time }
**50분 타이머.** 오늘 처음으로 **[흐름](../glossary.html#term-flow)을 처음부터 제작합니다.**
...
23. 고급 매개변수를 확장하여 필요한 데이터를 편집합니다. 제목, 지원자이름, 이메일, 지원직군, 경력사항, 이력서요약, 이력서링크를 체크합니다.
