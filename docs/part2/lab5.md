...
2. **사이트 주소**에 환경 변수 **`SPSiteUrl`** 칩을, **목록 이름**에 **본인 지원자 [목록](../glossary.html#term-list)**을 지정합니다.
...
10. 사이트 = **SPSiteUrl** 칩, 목록 = 본인 목록, **ID** = 트리거의 **ID** 칩, **제목** = 항목이 만들어진경우의 제목을 지정합니다.
    매개변수 초기화 후  **[요약승인상태](../glossary.html#term-summary-approval-status)** Value 값만 체크합니다. 그리고 `승인됨` 상태로 변경합니다.
